...
public class AWSSpimImageLoader implements ViewerImgLoader, MultiResolutionImgLoader
{
    ...
    /**
     * Maps setup id to {@link AWSSpimImageLoader.SetupImgLoader}.
     */
    private final Map< Integer, AWSSpimImageLoader.SetupImgLoader> setupImgLoaders = new HashMap<>();
...
//                    this.n5 = new N5FSReader( n5File.getAbsolutePath() );
                    ...
                    for ( final BasicViewSetup setup : setups )
                    {
                        ...
                        final AWSSpimImageLoader.SetupImgLoader setupImgLoader = createSetupImgLoader( setupId );
    ...
    @Override
    public AWSSpimImageLoader.SetupImgLoader getSetupImgLoader(final int setupId )
    {
        open();
        return setupImgLoaders.get( setupId );
    }

    private < T extends NativeType< T >, V extends Volatile< T > & NativeType< V > > AWSSpimImageLoader.SetupImgLoader< T, V > createSetupImgLoader(final int setupId ) throws IOException
    {
        ...
        {
            case UINT8:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new UnsignedByteType(), new VolatileUnsignedByteType() ) );
            case UINT16:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new UnsignedShortType(), new VolatileUnsignedShortType() ) );
            case UINT32:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new UnsignedIntType(), new VolatileUnsignedIntType() ) );
            case UINT64:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new UnsignedLongType(), new VolatileUnsignedLongType() ) );
            case INT8:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new ByteType(), new VolatileByteType() ) );
            case INT16:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new ShortType(), new VolatileShortType() ) );
            case INT32:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new IntType(), new VolatileIntType() ) );
            case INT64:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new LongType(), new VolatileLongType() ) );
            case FLOAT32:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new FloatType(), new VolatileFloatType() ) );
            case FLOAT64:
                return Cast.unchecked( new AWSSpimImageLoader.SetupImgLoader<>( setupId, new DoubleType(), new VolatileDoubleType() ) );
        }
        return null;
    }
    ...
    public static SimpleCacheArrayLoader< ? > createCacheArrayLoader(final N5Reader n5, final String pathName ) throws IOException
    {
        ...
        switch ( attributes.getDataType() )
        {
            case UINT8:
            case INT8:
                return new AWSSpimImageLoader.N5CacheArrayLoader<>( n5, pathName, attributes,
