//package com.bigdistributor.dataexchange.aws.s3.func.loader;
//
//
...
//
//
//public class AWSSpimLoader implements ViewerImgLoader, MultiResolutionImgLoader {
//
//    private final AWSXMLReader reader;
//
//    private final AbstractSequenceDescription<?,?,?> seq;
//
//    private final Map< Integer, Hdf5ImageLoader.SetupImgLoader> setupImgLoaders = new HashMap<>();
//
//
...
//
//    public AWSSpimLoader( final AWSXMLReader reader, final AbstractSequenceDescription< ?, ?, ? > sequenceDescription )
//    {
//        this.reader = reader;
