...
// K: Task Param
public class AWSSparkDistributedTaskV1<T extends NativeType<T>, K extends SerializableParams> implements Callable<Void> {
    ...
    public AWSSparkDistributedTaskV1(BlockTask task) {
        this.mainTask = task;
    }
